                  ...
                  <div class="card-body p-4 p-lg-5 text-black">
                    ...
                    <form>
                      ...
                      <div class="form-outline mb-5">
                        <input type="username" id="form2Example17" class="form-control form-control-lg" style="border-radius: 3rem;" placeholder="Username"/>
                      </div>
    
                      <div class="form-outline mb-5">
                        <input type="email" id="form2Example27" class="form-control form-control-lg" style="border-radius: 3rem;" placeholder="Email" />
                      </div>
